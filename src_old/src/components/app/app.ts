// import { type } from 'os';
// import { TodoPage } from '../../components/pages/todo.js';
import { consoleDebug } from '../tools/debug.js';
import { SeriesType } from '../types/series.js';
import { LiSerie } from '../menu/liSerie.js';
...
export class App {
    ...
    constructor() {
        ...
        try {
            new LiSerie('.mainDos', this.seriesType);
        } catch (error) {
